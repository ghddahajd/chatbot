...
HARD_RESTRICTED_KEYWORDS = {
    ...
    "гное",
    "опух",
    # Живой баг (2026-08-19): "лицо распухло, тяжело дышать" (аллергическая реакция) не ловилось
    # ни одним словом — "опух" не покрывает "распухло" (другой префикс, не подстрока), "дышать"
    # не было вообще. RAG-рескью в medical_requested подхватывал ответ по совпадающим общим
    # словам ("лицо"/"красное") с одобренной статьёй, вместо эскалации. Найдено live-тестом
    # при ревью очередной статьи (см. article_service_map.yaml, красное лицо), не гипотетически.
    "распух",
    "дышать",
    "дыхание",
