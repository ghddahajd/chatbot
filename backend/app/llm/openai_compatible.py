            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "настоящее имя). Если клиент назвал НЕСКОЛЬКО номеров телефона — в "
                        "карточке показан только один, поэтому прямо процитируй оба номера в "
                        "саммари, чтобы оператору не пришлось искать их в переписке. Ответь "
                        "только текстом саммари, без вступлений и списков."
                    ),
                },
